...
:root{font-family:Inter,ui-sans-serif,system-ui,sans-serif;color:#e8ecf4;background:#0b1020}*{box-sizing:border-box}body{margin:0;background:#0b1020;color:#e8ecf4}header,main{width:min(1180px,calc(100% - 2rem));margin:auto}header{display:flex;justify-content:space-between;align-items:center;padding:1.25rem 0;border-bottom:1px solid #252d42}header a{color:#f28b8f;text-decoration:none}main{min-height:calc(100vh - 198px);padding:2rem 0}h1{margin:0 0 .5rem}p{color:#aeb8cc}.summary{display:flex;gap:1rem;flex-wrap:wrap;margin:1.5rem 0}.card{padding:1rem 1.25rem;border:1px solid #29324a;background:#12192b;border-radius:8px}.card strong{display:block;margin-top:.3rem;color:#fff}table{width:100%;border-collapse:collapse;background:#12192b;border:1px solid #29324a}th,td{text-align:left;vertical-align:top;padding:.8rem;border-bottom:1px solid #29324a}th{color:#aeb8cc;font-size:.8rem;text-transform:uppercase;letter-spacing:.04em}code{display:inline-block;max-width:44rem;overflow-wrap:anywhere;color:#e8ecf4}.status{font-weight:700}.status.present{color:#75d69c}.status.missing,.status.mismatch{color:#ff9d91}.status.not_checked,.status.unsupported{color:#f0c674}.note{margin-top:1.2rem;padding:1rem;border-left:3px solid #f0c674;background:#171b2a}.gotth-footer{min-height:104px;display:flex;align-items:center;gap:.5rem 1.25rem;flex-wrap:wrap;padding:1.4rem clamp(1rem,10vw,7.5rem);background:#050817;border-top:1px solid #262b3b;color:#9da8bd}.gotth-footer strong{color:#f4f6fb}.gotth-footer .product{color:#f28b8f}@media(max-width:760px){header{align-items:flex-start;gap:1rem}table,thead,tbody,tr,th,td{display:block}thead{display:none}tr{border-bottom:1px solid #29324a}td{border:0;padding:.5rem .8rem}td::before{content:attr(data-label);display:block;color:#7f8ba3;font-size:.72rem;text-transform:uppercase}.gotth-footer{min-height:72px;padding:.75rem 1rem;font-size:12px}}
