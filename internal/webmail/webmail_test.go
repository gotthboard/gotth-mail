...
func (f fakeSigner) SignMIME(ctx context.Context, id Identity, b []byte) ([]byte, SignatureStatus, error) {
	...
	return append([]byte("Content-Type: multipart/signed; protocol=application/pgp-signature; micalg=pgp-sha256; boundary=sig\r\n\r\n--sig\r\n"), append(b, []byte("\r\n--sig\r\nContent-Type: application/pgp-signature\r\n\r\nfake-signature\r\n--sig--")...)...), SignatureStatus{Fingerprint: id.Fingerprint, Identity: id.Address, Signed: true}, nil
}
