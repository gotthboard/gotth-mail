...
1. Forgejo owns the canonical private repository at
   `gotthboard/gotth-mail`; the former URL redirects.
...
6. The GitHub distribution repository and push mirror are either proven at the
   same refs or recorded as an explicit delivery blocker.
