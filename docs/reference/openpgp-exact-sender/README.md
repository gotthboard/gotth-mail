...
These drafts are project reference material for GOTTH Mail's mandatory exact-sender OpenPGP/MIME signing requirement.
...
The drafts are not a substitute for implementation evidence. GOTTH Mail PRDs, architecture, implementation specs, tests, and workflow evidence still define what is implemented in each version.
