...
func TestReferenceComposeExposesOptInSignedEmailNotificationPlugin(t *testing.T) {
	...
	for _, want := range []string{
		...
		"GMF_PLUGIN_NAME: signed-email-notification-sink",
		"GMF_NOTIFICATION_EMAIL_FROM:",
		"GMF_NOTIFICATION_EMAIL_TO:",
		"GMF_NOTIFICATION_EMAIL_SIGNING_FINGERPRINT:",
		"GMF_NOTIFICATION_EMAIL_PRIVATE_KEY_FILE: /run/secrets/notification-signing-key.asc",
		"GMF_NOTIFICATION_EMAIL_SMTP_ADDR: ${GMF_NOTIFICATION_EMAIL_SMTP_ADDR:-postfix:25}",
		"source: ${GMF_NOTIFICATION_EMAIL_PRIVATE_KEY_SOURCE:-./secrets/notification-signing-key.asc}",
