...
printf '%s\n' "{\"imap_addr\":\"dovecot:143\",\"smtp_addr\":\"postfix:25\",\"smtp_hello_name\":\"gotth-mail-webmail-smoke\",\"smtp_auth_mechanism\":\"cram-md5\",\"mailboxes\":[{\"address\":\"smoke@example.test\",\"imap_password_file\":\"/run/secrets/webmail-imap-password\",\"smtp_password_file\":\"/run/secrets/webmail-smtp-password\",\"signing_fingerprint\":\"$fingerprint\",\"private_key_file\":\"/run/secrets/webmail-signing-key.asc\"}]}" >"$FIXTURE/runtime.json"
